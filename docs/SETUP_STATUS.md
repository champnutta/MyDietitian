...
- `lineWebhook` staging correction flow now supports latest-meal text correction and portion adjustment commands such as `ไม่ใช่...เป็น...` and `กินครึ่งเดียว` against Firestore meal logs.
