...
- Latest `npm run migration:readiness-packet -- --project mydietitian --serviceAccount "C:\Users\champ\AppData\Roaming\firebase\znak_iiz_gmail.com_application_default_credentials.json" --smoke-write --evidence-file docs/MANUAL_UAT_EVIDENCE.md --manual-line-media-pass --manual-liff-auth-pass --rollback-reviewed --security-preflight-pass --owner-approval --out docs/FINAL_MIGRATION_READINESS_PACKET.md --json-out docs/FINAL_MIGRATION_READINESS_PACKET.json` says `ready-for-final-data-migration-window`.
