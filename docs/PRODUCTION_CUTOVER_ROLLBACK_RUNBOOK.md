...
- The JSON readiness packet was generated by `npm run migration:readiness-packet` within the last 6 hours for project `mydietitian`; it has completed evidence, all manual gates, all automated checks, and no blockers.
