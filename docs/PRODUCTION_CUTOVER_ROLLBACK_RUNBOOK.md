...
- Latest readiness packet is generated with `LINE_CHANNEL_SECRET` set in the environment, has no skipped automated checks, and says `ready-for-final-data-migration-window`.
