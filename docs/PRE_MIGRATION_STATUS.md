...
This consolidates deployed Firebase Functions, AI provider fallback config, LINE text UAT, portion/subscription/target-confirmation contract checks, Google Sheet dry-run counts, and the pre-migration gate. It does not write migrated data or switch the production LINE webhook.
