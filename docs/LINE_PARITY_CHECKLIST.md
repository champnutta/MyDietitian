...
- Route text commands. Partial: staging supports help, profile/status, dashboard link, daily summary, weight log, undo latest meal, quick setup, subscription, redeem code, contact admin, exercise logs, coach consultation, and menu recommendations.
