...
function main() {
  ...
  let output = template
    ...
    .replace("| Pre-migration audit | all checks pass with `--smoke-write --useLineSecretManager` |  |", `| Pre-migration audit | all checks pass with \`--smoke-write --useLineSecretManager\` | ${summarizePreMigrationAudit(preCutover.json)} |`)
